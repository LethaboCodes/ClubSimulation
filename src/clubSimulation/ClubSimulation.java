...
public class ClubSimulation {	
	static String paused = "Resume "; 
	static String resumed = "Pause ";
	static String current = resumed;
  ...
  static int frameX=400;
	...
	private static int minWait=500; //for the fastest cutomerz
		...
		startB.addActionListener(new ActionListener() {
			...
			pauseB.addActionListener(new ActionListener() {
		      public void actionPerformed(ActionEvent e) {
						...
						if(current == paused){
							pauseB.setText(resumed);
							current = resumed;
						}else if(current == resumed){
							pauseB.setText(paused);
							current = paused;
						}
						
							if (Clubgoer.freeze.get() == false){
								Clubgoer.freeze.set(true);
							}else if(Clubgoer.freeze.get() == true){
								Clubgoer.freeze.set(false);
							}
